    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">说唱押韵与 Rap 填词</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 说唱押韵与 Rap 填词助手</span>
...
// 清理回复末尾的特殊标记 [SHUOCHANG_SCORES]...[/SHUOCHANG_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[SHUOCHANG_SCORES\][\s\S]*?\[\/SHUOCHANG_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 说唱押韵与 Rap 词曲填词专家】\n\n${cleanContent.value}\n\n体验说唱AI助手：https://ai.wuxian.xyz`;
